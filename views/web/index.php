<div class="text-indigo-100 bg-indigo-700 dark:bg-gray-800 dark:text-gray-200">
  <div class="flex items-center justify-between h-16 max-w-6xl px-6 mx-auto">
    ...
    <ul class="flex items-center space-x-8 font-semibold" role="navigation">
      <li><a href="https://github.com/estevanmaito/tailwindcss-multi-theme">Github</a></li>
      <li><a href="https://github.com/estevanmaito/tailwindcss-multi-theme/tree/master/examples">Examples</a></li>
      <li><a href="https://github.com/estevanmaito/tailwindcss-multi-theme/blob/master/README.md#-install">Docs</a></li>
      <li>
...
<header class="">
  <div class="flex flex-col max-w-6xl px-6 py-16 mx-auto md:flex-row">
    <div class="flex flex-col justify-center pr-4 md:w-1/2">
      <div>
        <a class="inline-flex items-center pl-1 pr-2 mb-3 bg-indigo-100 rounded-full dark:bg-gray-800" href="https://github.com/estevanmaito/tailwindcss-multi-theme/tree/master/examples/with-alpine">
          ...
          <span class="text-sm leading-loose text-indigo-800 dark:text-gray-300">Copy the code of this page &RightArrow;</span>
        </a>
      </div>
    ...
    <div class="md:w-1/2">
      <img class="w-full" src="/assets/svg/wfh_1.svg" alt="Woman working from home">
    </div>
  </div>
</header>
    ...
    <div class="grid gap-8 md:grid-cols-3">
      ...
      <div
        ...
        <div>
          ...
          <p class=""><a class="text-blue-600 dark:text-blue-300"
                         href="https://github.com/estevanmaito/tailwindcss-multi-theme/tree/master/examples/simple">The
              code</a> for this example is available for you to copy.</p>
        </div>
      </div>
    </div>
  </div>
