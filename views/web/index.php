<body class="dark:bg-gray-900">
  <div class="text-indigo-100 bg-indigo-700 dark:bg-gray-800 dark:text-gray-200">
    <div class="flex items-center justify-between h-16 max-w-6xl px-6 mx-auto">
      ...
      <ul class="flex space-x-8 font-semibold" role="navigation">
        <li><a href="#">Products</a></li>
        <li><a href="#">Support</a></li>
        <li><a href="#">Contact</a></li>
        <li><a class="px-6 py-2 text-orange-100 bg-orange-600 rounded-full" href="#">Log in</a></li>
      </ul>
    </div>
  </div>
  <header class="">
      ...
      <div class="flex flex-col justify-center pr-4 md:w-1/2">
        <div>
          <a class="inline-flex items-center pl-1 pr-2 mb-3 bg-indigo-100 rounded-full dark:bg-gray-800" href="#">
            ...
            <span class="text-sm leading-loose text-indigo-800 dark:text-gray-300">Visit our new products page &RightArrow;</span>
          </a>
        </div>
        ...
        <p class="mt-6 mb-12 text-lg text-gray-700 dark:text-gray-400">You can change this theme even by inspecting the code and applying the class <code class="px-1 text-purple-500 bg-gray-100 rounded dark:text-purple-200 dark:bg-gray-800">theme-dark</code> around</p>
        <div>
          <a class="px-6 py-2 font-semibold text-orange-100 bg-orange-600 rounded-full" href="#">Read more</a>
        </div>
      </div>
      <div class="md:w-1/2">
      ...
      <div class="grid gap-8 md:grid-cols-3">
        ...
        <div class="flex items-center p-4 space-x-4 text-gray-700 rounded-lg shadow-xl dark:bg-gray-800 dark:text-gray-300">
          ...
          <div>
            ...
            <p class=""><a class="text-blue-600 dark:text-blue-300" href="https://github.com/estevanmaito/tailwindcss-multi-theme/tree/master/examples/simple">The code</a> for this example is available for you to copy.</p>
          </div>
        </div>
      </div>
    </div>
